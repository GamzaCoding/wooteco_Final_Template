...
public class FileReadFor {
    ...
    public void CsvFileReader() {
        ...
        if (inputStream == null) {
            throw new IllegalArgumentException("products.md 파일이 없습니다.");
        }
    ...
    public void promotionReader() {
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream("promotion.md");
